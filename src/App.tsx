            ...
            <div className="p-8 max-w-md mx-auto sm:max-w-xl lg:py-24 lg:px-12 lg:max-w-full lg:w-1/2">
                <div className="xl:max-w-lg xl:ml-auto">
                    ...
                    <h1 className="mt-4 text-3xl font-bold text-gray-800 leading-tight tracking-tighter sm:text-4xl sm:mt-8">
                        ...
                        <br />
                        <span className="text-blue-800">Find it now!</span>
                    </h1>
                    ...
                    <div className="mt-4 sm:mt-6">
                        <a
                            href="/"
                            className="inline-block px-5  py-3 bg-blue-800 text-white uppercase font-semibold tracking-wider rounded-lg shadow-lg sm:text-lg"
                        >
                            See listings
                        </a>
                    </div>
